...
export class PostProvider {
	...
	ipaddress(i) {
		this.ip = i;
		this.link = this.ip + '/vci_mobile_api/index.php/mobile_vci_app/';
	...
	postDataLogin(body, file) {
		...
		return this.http.post("https://mobile1.vci.co.id/vci_mobile_api/index.php/mobile_vci_app/" + file, JSON.stringify(body), options).map(res => res.json());
		// return this.http.post("http://app.vci.co.id:88/vci_mobile_api/index.php/mobile_vci_app/" + file, JSON.stringify(body), options).map(res => res.json());
	...
	postDataRegtim(body, file) {
		...
		return this.http.post("https://mobile2.vci.co.id/vci_mobile_api/index.php/mobile_vci_app/" + file, JSON.stringify(body), options).map(res => res.json());
