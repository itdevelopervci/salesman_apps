...
export class HistorytranspendingdetailPage {
  ...
  selectTransactionDisc() {
    ...
    this.postPvdr.postData(body, 'Transaction').subscribe((data) => {
      ...
      //   location: 'default'
      // }).then((db: SQLiteObject) => {
      //   db.executeSql('UPDATE trans_so_disc SET send_status = 0 WHERE NoSO = ?', [this.noso])
      //     .then(res => {
      //       console.log("Success update send_status = 0 table trans_so_disc_in where transaction number", this.noso);
      //     })
      //     .catch(e => console.log("Failed update send_status = 0 table trans_so_disc", e));
      // });
    });
  }
  ...
  selectTransactionDet() {
    ...
    this.postPvdr.postData(body, 'Transaction').subscribe((data) => {
      ...
      //   location: 'default'
      // }).then((db: SQLiteObject) => {
      //   db.executeSql('UPDATE trans_so_det SET send_status = 0 WHERE NoSO = ?', [this.noso])
      //     .then(res => {
      //       console.log("Success update send_status = 0 table trans_so_det_in where transaction number", this.noso);
      //     })
      //     .catch(e => console.log("Failed update send_status = 0 table trans_so_det", e));
      // });
    });
  }
  ...
  selectTransactionHeader() {
    ...
    this.postPvdr.postData(body, 'Transaction').subscribe((data) => {
      ...
      //   location: 'default'
      // }).then((db: SQLiteObject) => {
      //   db.executeSql('UPDATE trans_so SET send_status = 0 WHERE NoSO = ?', [this.noso])
      //     .then(res => {
      //       console.log("Success update send_status = 0 table trans_so_in where transaction number ", this.noso);
      //     })
      //     .catch(e => console.log("Failed update send_status = 1 table trans_so", e));
      // });
    });
  }
