...
export class CheckinPage {
  ...
  // getCurrentData(idcheckin, kdsalesman, kdoutlet, nama_outlet, truelocation, longitude, latitude, waktuin, kdcabang, tglcheckin, sendstatus) {
  ...
  //   console.log('Waktu in: ', this.waktuin);
